...
public class ServiceForm extends javax.swing.JInternalFrame {
    ...
    System.out.println("Client ID sélectionné : " + serviceId);

     String newNom = txtNom.getText();
        
        Service selectedService = new Service(serviceId, newNom);

        boolean updated = ss.update(selectedService);

    if (updated) {
        JOptionPane.showMessageDialog(this, "Service mis à jour avec succès.");
        load();
    } else {
        JOptionPane.showMessageDialog(this, "La mise à jour du service a échoué.", "Erreur", JOptionPane.ERROR_MESSAGE);
    }
} catch (Exception e) {
